---
name: qa-apply
description: "Trigger: implementar un cambio QA aprobado. Escribe tests con Screenplay+POM (G5) siguiendo el spec y las convenciones del proyecto, bajo el gate real del Core — nunca una promesa de prompt."
license: Apache-2.0
metadata:
