---
name: gitlab-mr-flow
description: "Trigger: crear MR, mergearlo a main o versionarlo. Orquesta un MR de GitLab: push, crear (assigner+reviewer), verificar aprobacion y mergear por API."
license: Apache-2.0
metadata:
