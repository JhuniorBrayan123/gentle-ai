...
description: "Trigger: crear tag de un MR mergeado, versionar el merge, crear release. Crea una etiqueta semver X.Y.Z (SmartClic) con changelog del MR sobre la rama destino."
license: Apache-2.0
metadata:
