...
func TestSkillPickerCanonicalRowsAndActions(t *testing.T) {
	...
	labels := []string{"SDD Init", "SDD Explore", "SDD Propose", "SDD Spec", "SDD Design", "SDD Tasks", "SDD Apply", "SDD Verify", "SDD Archive", "SDD Onboard", "Judgment Day", "qa-explore", "qa-spec", "qa-apply", "qa-verify", "qa-review", "qa-docs", "Go Testing", "Gentle AI Bench", "Skill Creator", "Skill Improver", "Branch & PR", "Issue Creation", "Skill Registry", "Chained PR", "Cognitive Doc Design", "Comment Writer", "Work Unit Commits", "RDD Defect Workflow", "Systemic Issue Triage", "qa-supervisor", "qa-doc-access", "qa-evidence", "gitlab-mr-flow", "gitlab-release-tag"}
